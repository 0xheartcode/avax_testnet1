...
We'll query the current blocknumber with: let blockNumber = await web3.eth.getBlockNumber()

Note that the object web3 is injected by Remix. For more info on web3.js, check their docs, https://web3js.readthedocs.io.
